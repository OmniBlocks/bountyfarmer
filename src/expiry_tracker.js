 ...
 * @property {number} remainingSeconds - Seconds remaining before expiration (or negative if expired).
...
export class ExpiryTracker {
   ...
   * @param {number} [windowMinutes=30] - Expiry threshold duration in minutes.
   */
  constructor(createdAt, windowMinutes = 30) {
   ...
   *
   * @param {string|Date} [referenceTime] - Optional reference time for deterministic testing.
